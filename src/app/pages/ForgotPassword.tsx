          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="text-center">
                <Link to="/login" className="inline-flex items-center text-sm text-[#8268AB] hover:underline">
          ...
          <div className="mt-8 pt-6 border-t border-white/10">
            <div className="flex items-start space-x-3 text-sm text-muted-foreground">
              ...
              <p>
                ...
                <a href="mailto:hallo@happyager.com" className="text-[#1b2a23] hover:underline">
                  hallo@happyager.com
                </a>
              </p>
            </div>
