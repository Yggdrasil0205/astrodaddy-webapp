          ...
          <GlassCard className="rounded-3xl p-8 md:p-12">
            ...
            <div className="space-y-8 text-[#1b2a23]/90">
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">2.1 Umfang der Verarbeitung personenbezogener Daten</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">2.2 Rechtsgrundlage</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">2.3 Datenlöschung und Speicherdauer</h3>
                <p>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">3.1 Beschreibung und Umfang der Datenverarbeitung</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">3.3 Zweck der Datenverarbeitung</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">3.4 Dauer der Speicherung</h3>
                <p>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">4.1 Beschreibung und Umfang</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">4.2 Cookie-Kategorien</h3>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">4.4 Widerspruchs- und Beseitigungsmöglichkeit</h3>
                <p>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">5.2 Rechtsgrundlage</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">5.3 Zweck der Datenverarbeitung</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">5.4 Dauer der Speicherung</h3>
                <p>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">6.1 Verarbeitung von Bestelldaten</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">6.3 Zahlungsdienstleister</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">6.4 Speicherdauer</h3>
                <p>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">7.1 Beschreibung und Umfang</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">7.2 Newsletter-Dienstleister</h3>
                <p className="mb-4">
                  ...
                  Datenschutzerklärung: <a href="https://www.klick-tipp.com/datenschutzerklaerung" target="_blank" rel="noopener noreferrer" className="text-[#8268AB] hover:underline">klick-tipp.com/datenschutzerklaerung</a>
                </p>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">7.3 Rechtsgrundlage</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">7.4 Widerruf</h3>
                <p>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">8.1 Google Analytics</h3>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  ...
                  <a href="https://tools.google.com/dlpage/gaoptout" target="_blank" rel="noopener noreferrer" className="text-[#8268AB] hover:underline ml-1">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">8.2 Hotjar</h3>
                <p className="mb-4">
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">9.1 Social Media Präsenzen</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">9.2 Facebook</h3>
                <p className="mb-4">
                  Anbieter: Meta Platforms Ireland Limited, 4 Grand Canal Square, Dublin 2, Irland<br />
                  Datenschutzerklärung: <a href="https://www.facebook.com/privacy/explanation" target="_blank" rel="noopener noreferrer" className="text-[#8268AB] hover:underline">facebook.com/privacy</a>
                </p>

                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">9.3 Instagram</h3>
                <p className="mb-4">
                  Anbieter: Meta Platforms Ireland Limited, 4 Grand Canal Square, Dublin 2, Irland<br />
                  Datenschutzerklärung: <a href="https://help.instagram.com/519522125107875" target="_blank" rel="noopener noreferrer" className="text-[#8268AB] hover:underline">instagram.com/privacy</a>
                </p>
              </section>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">10.1 Facebook Pixel / Meta Pixel</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">10.2 Google Ads und Conversion-Tracking</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">10.3 LinkedIn Insight Tag</h3>
                <p className="mb-4">
                ...
                <p className="mb-4">
                  Datenschutzerklärung: <a href="https://www.linkedin.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer" className="text-[#8268AB] hover:underline">linkedin.com/privacy</a>
                </p>

                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">10.4 TikTok Pixel</h3>
                <p className="mb-4">
                ...
                <p>
                  Datenschutzerklärung: <a href="https://www.tiktok.com/legal/privacy-policy-eea" target="_blank" rel="noopener noreferrer" className="text-[#8268AB] hover:underline">tiktok.com/privacy</a>
                </p>
              </section>
              ...
              <section>
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.1 Auskunftsrecht (Art. 15 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.2 Recht auf Berichtigung (Art. 16 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.3 Recht auf Löschung (Art. 17 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.4 Recht auf Einschränkung der Verarbeitung (Art. 18 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.5 Recht auf Datenübertragbarkeit (Art. 20 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.6 Widerspruchsrecht (Art. 21 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.7 Recht auf Widerruf der Einwilligung (Art. 7 Abs. 3 DSGVO)</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mb-2 text-[#1b2a23]">11.8 Beschwerderecht bei einer Aufsichtsbehörde (Art. 77 DSGVO)</h3>
                <p className="mb-4">
