...
export const products: Product[] = [
  {
    ...
    previewImages: ['/jahresvorschau-lg.png'],
    badge: 'Angebot',
    bestseller: true,
    category: 'Analyse',
  ...
  {
    id: 4,
    name: 'Astrologische Persönlichkeitsanalyse (schriftlich)',
    shortDescription: 'Entdecke deine astrologische DNA – inspiriert von deinem individuellen Geburtshoroskop.',
    description: 'Eine schriftliche Persönlichkeitsanalyse auf Basis deines Geburtshoroskops – ca. 25–30 Seiten, individuell auf deine Geburtsdaten zugeschnitten. Bewusste und unbewusste Charakterzüge, Planetenstellungen, Aspekte und Häuser aus psychologischer und spiritueller Perspektive.',
    price: 49.99,
    priceFormatted: '49,99 €',
    originalPrice: 69.99,
    originalPriceFormatted: '69,99 €',
    image: '/persoenlichkeitsanalyse.png',
    badge: 'Angebot',
    category: 'Analyse',
  ...
  },
  {
    ...
    price: 169.99,
    priceFormatted: '169,99 €',
    originalPrice: 199.99,
    originalPriceFormatted: '199,99 €',
