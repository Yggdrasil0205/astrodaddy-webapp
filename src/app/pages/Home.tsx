    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
        ...
        <div className="fixed inset-0 pointer-events-none overflow-hidden -z-10">
          <div className="absolute inset-0 bg-gradient-to-b from-[#1a0d2e] via-[#2D1B4E] to-[#f5f0e8] opacity-10" />
          <motion.div
            animate={{ scale: [1, 1.3, 1], opacity: [0.15, 0.35, 0.15], rotate: [0, 180, 360] }}
            transition={{ duration: 30, repeat: Infinity, ease: 'linear' }}
            className="absolute top-10 right-10 w-[600px] h-[600px] rounded-full bg-gradient-to-br from-[#5C3D8F]/20 to-transparent blur-3xl"
          />
          <motion.div
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-[#5C3D8F]/20 to-[#C9A84C]/20 backdrop-blur-sm mb-6">
              <Star className="w-4 h-4 mr-2 text-[#C9A84C]" />
              <span className="text-sm text-[#5C3D8F] font-medium">Astrologie · Tarot · Ausbildung</span>
            </div>
            ...
            <h1 className="text-5xl md:text-7xl font-bold mb-6 leading-tight">
              ...
              <br />
              <span className="bg-gradient-to-r from-[#C9A84C] via-[#5C3D8F] to-[#1a0d2e] bg-clip-text text-transparent">
                Universum
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/angebote">
                <Button size="lg" className="bg-[#5C3D8F] hover:bg-[#5C3D8F]/90 text-white px-8 py-4 text-lg rounded-2xl">
                  <Star className="w-5 h-5 mr-2" />
                  Angebote entdecken
                </Button>
              </Link>
              <Link to="/ausbildung">
                <Button size="lg" variant="outline" className="border-[#5C3D8F] text-[#5C3D8F] hover:bg-[#5C3D8F]/10 px-8 py-4 text-lg rounded-2xl">
                  Zur Ausbildung
            ...
            <div className="flex flex-wrap gap-4 justify-center mt-10">
              {['5/5 Sterne auf Google', '100% Zufriedenheitsrate', 'TikTok & Instagram'].map(b => (
                <div key={b} className="flex items-center gap-2 px-4 py-2 rounded-full bg-white/60 backdrop-blur-sm border border-white/40">
                  <CheckCircle className="w-4 h-4 text-[#5C3D8F]" />
            ...
            {features.map((f, i) => (
              <motion.div key={f.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }}>
                <GlassCard className="rounded-2xl p-6 h-full hover:shadow-lg transition-shadow">
                  <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-[#5C3D8F]/20 to-[#C9A84C]/20 flex items-center justify-center mb-4">
                    <f.icon className="w-6 h-6 text-[#5C3D8F]" />
                  </div>
      ...
      <section className="py-24 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center mt-10">
            <Link to="/angebote">
              <Button size="lg" variant="outline" className="border-[#5C3D8F] text-[#5C3D8F] hover:bg-[#5C3D8F]/10 rounded-2xl px-8">
      ...
      {/* Testimonials */}
      <section className="py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-transparent to-[#5C3D8F]/5">
        <div className="max-w-7xl mx-auto">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              <span className="bg-gradient-to-r from-[#1a0d2e] via-[#5C3D8F] to-[#C9A84C] bg-clip-text text-transparent">
